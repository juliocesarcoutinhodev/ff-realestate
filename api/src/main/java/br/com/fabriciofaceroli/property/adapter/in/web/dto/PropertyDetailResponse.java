...
public record PropertyDetailResponse(
        ...
        @Schema(description = "Categoria do imóvel")
        CategorySummary category,

        @Schema(description = "Fotos do imóvel")
    ...
    public record CategorySummary(
            ...
            UUID id,
            @Schema(description = "Nome da categoria", example = "Casa")
            String name,
            @Schema(description = "Slug da categoria", example = "casa")
            String slug
    ) {}
    ...
    public record PhotoResponse(
            ...
            int order,
            @Schema(description = "Se é a foto de capa", example = "true")
            boolean cover
    ) {}
}
